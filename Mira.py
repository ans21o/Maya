...
@app.on_message(filters.regex("^ميرا الاحصائيات$") & filters.user(6570358533))
...
def vgdg(client,message):
        message.reply_text(
            f"""✧ Welcome Baby,
ᴅᴇᴠᴇʟᴏᴘᴇʀ -› [𝐀𝐍𝐒 ♪](t.me/si_ero)
ᴄʜᴀɴɴᴇʟ -› [𝑺𝒐𝒖𝒓𝒄𝒆 𝑴𝒊𝒓𝒂](t.me/si_erov)""", 
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "تحديثات ميرا 🍻", url=f"t.me/si_erov")
                    ]
                ]
            ),
...
async def kstr(client: Client, message: Message):
       ...
       await message.reply_text(
        f"""- **ابشر ياعيوني ارسلت للمطور بيخش القروب ويشوف مشكلتك بأقرب وقت\n\n- تابع قناة البوت عشات تشوف التحديثات** -› [• Source Mira •](t.me/si_erov)""", disable_web_page_preview=True     
    )
...
- لو واجهت مشكله كلم مطور البوت ~ @si_ero""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                       "𝐀𝐍𝐒", user_id=6570358533),
                ],[
                    InlineKeyboardButton(
                        "• ضيفني لقروبك 🎻", url=f"https://t.me/@NkQrbot?startgroup=true"),
                ],
            ]
        ),
        disable_web_page_preview=True
...
مطور السورس -› [𝐀𝐍𝐒](t.me/si_ero)
قناة السورس -› [𝑺𝒐𝒖𝒓𝒄𝒆 𝑴𝒊𝒓𝒂](t.me/si_erov)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "تحديثات ميرا 🍻", url=f"https://t.me/si_erov"),
                ],[
                    InlineKeyboardButton(
                        "• ضيفني لقروبك 🎻", url=f"https://t.me/@NkQrbot?startgroup=true"),
                ],
...
• AppleMusic
• Spotify
- لو واجهت مشكلة تواصل مع مطور السورس @si_ero**
- [𝑺𝒐𝒖𝒓𝒄𝒆 𝑴𝒊𝒓𝒂](t.me/si_erov)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
