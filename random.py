...
async def musicme(client, message):
       ...
       if message.chat.id not in disable:
         ...
         url = f"https://t.me/si_erov/{rl}"
         await message.reply_voice(url,caption="-› [• 𝑷𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝑴𝒊𝒓𝒂 •](t.me/si_erov)")
...
async def ava(client, message):
       ...
       if message.chat.id not in disable_A:
         ...
         url = f"https://t.me/si_erov/{rl}"
         await message.reply_photo(url,caption="-› [• 𝑷𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝑴𝒊𝒓𝒂 •](t.me/si_erov)")
...
async def qw2(client,message):
       ...
       if message.chat.id not in disable_G:
         ...
         url = requests.get(f"https://t.me/si_erov/{rl}").text
